...
<html lang="en">
  ...
  <head prefix="og: http://ogp.me/ns# volteer: 
                  http://ogp.me/ns/apps/volteer#">
  ...
  <meta property="og:url" content="http://studentweb.comminfo.rutgers.edu/class-2012-1-16-198-675-01/nirg/dev/20120421/ram_event_store.php">
...
mysql_connect("localhost", "bshankar", "dMFh.EwIjx5J") or die(mysql_error());
 ...
 $url='http://studentweb.comminfo.rutgers.edu/class-2012-1-16-198-675-01/bshankar/volteer_ram/Volteer_ram/mine/event_detail.php?id='.$row['eventid'];
 $attachment = array(
...
//header( 'Location: http://studentweb.comminfo.rutgers.edu/class-2012-1-16-198-675-01/bshankar/volteer_ram/Volteer_ram/mine/index_fblogin.php' ) ;
;
$ch = curl_init();
$url="https://graph.facebook.com/me/volteer:create" ;
$post_data="event=http://studentweb.comminfo.rutgers.edu/class-2012-1-16-198-675-01/bshankar/volteer_ram/Volteer_ram/mine/event_store.php&access_token=".$access_token;
